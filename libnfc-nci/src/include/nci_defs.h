...
#define NCI_ANDROID_SET_PASSIVE_OBSERVER_EXIT_FRAME 0x05
#define NCI_ANDROID_GET_PASSIVE_OBSERVER_EXIT_FRAME 0x06
#define NCI_ANDROID_BLANK_NCI 0x7
#define NCI_ANDROID_SET_PASSIVE_OBSERVER_TECH 0x08
